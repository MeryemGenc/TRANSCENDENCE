...
export function stopGame_3d() {
    ...
    if (getGameRunning()) { setGameRunning(false); }

    // Oyunu durdurmak için animasyonu iptal et
    cancelAnimationFrame(animate);

    // Puanları API'ye gönder
    post_game_score(player1Score, player2Score);

    // Oyun bittiğinde sahneyi temizle
    cleanUpScene();

    // Kullanıcıya oyunun bittiğini göster
    ...
    gameOverMessage.innerText = `Oyun Bitti! ${player1Score > player2Score ? "Oyuncu 1" : "Oyuncu 2"} kazandı!`;
